...
exports.getAll = (req, res) => {
    ...
    Rent.findAndCountAll({
        ...
        .catch(err => {
            res.status(500).send({
                message:
                    err.message || "Some error occurred while retrieving Rent list."
            });
        });
};
...
exports.create = async (req, res) => {
    ...
    Rent.create(rent).then(data => {
        ...
        res.status(400).send({
            message: err.message || 'Some error occurred while creating the Rent.'
        });
    })
}
